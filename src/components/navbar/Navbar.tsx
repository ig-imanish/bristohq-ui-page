      ...
      <nav>
        ...
        <div className="left-menu">
          ...
          <ul>
            {navLinks.map((link) => (
              <li key={link.text}>
                <Button variant="link" url={link.url} text={link.text} />
              </li>
            ))}
          </ul>
        </div>
        <div className="right-menu">
          <ul>
            ...
            <div className="line"></div>
            <li>
              <a href="https://github.com/bristohq/ui">
                ...
                <span>{githubStars || 0}</span>
              </a>
            </li>
            <li>
              <a href="https://www.npmjs.com/package/@bristohq/ui" title="Monthly downloads">
                <svg width="18" height="18" viewBox="0 0 32 32" fill="none">
                  <rect width="32" height="32" rx="6" fill="#CB3837" />
                  <path fill="#fff" d="M7 13v6h3v-4h2v4h3v-6H7zm11 0v6h3v-4h2v4h3v-6H18z" />
                </svg>
                <span>{npmDownloads !== null ? npmDownloads.toLocaleString() : "--"}</span>
              </a>
            </li>
            <div className="line"></div>
            <li>
              <a href="https://x.com/@BristoHQ">
                <svg fill="white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
