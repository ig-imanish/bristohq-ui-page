...
const navLinks = [
  { url: "/", text: "Docs" },
  { url: "/about", text: "Components" },
  { url: "/contact", text: "Blocks" },
  { url: "/contact", text: "Charts" },
  { url: "/contact", text: "Themes" },
  { url: "/contact", text: "Colors" },
];
      ...
      <nav>
        ...
        <div className="right-menu">
          <ul>
            ...
            <li>
              <a href="https://ui.shadcn.com/favicon.ico">
